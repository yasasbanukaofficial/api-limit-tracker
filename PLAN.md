...
## 1️⃣ Project Summary (Interview-Ready)
...
_"I built a SaaS-style backend that issues API keys, tracks usage per key, and enforces configurable rate limits using Express middleware, Prisma, PostgreSQL, and full test-driven development (TDD)."_
